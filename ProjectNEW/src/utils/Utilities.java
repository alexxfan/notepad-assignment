...
public class Utilities {
    ...
    public static String booleanToDoCompleted(boolean booleanToConvert) {
        return booleanToConvert ? "Completed" : "TODO";
    }

    public static String booleanIsNoteArchived(boolean booleanToConvert) {
        return booleanToConvert ? "Archived=Y" : "Archived=N";
    }
}